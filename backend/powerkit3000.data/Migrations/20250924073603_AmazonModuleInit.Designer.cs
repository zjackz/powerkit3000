...
namespace powerkit3000.data.Migrations
{
    ...
    [Migration("20250924073603_AmazonModuleInit")]
    partial class AmazonModuleInit
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("powerkit3000.data.Models.AmazonCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("powerkit3000.data.Models.AmazonProduct", b =>
                {
            ...
            modelBuilder.Entity("powerkit3000.data.Models.AmazonProductDataPoint", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("powerkit3000.data.Models.AmazonSnapshot", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("powerkit3000.data.Models.AmazonTrend", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("powerkit3000.data.Models.ProjectFavorite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("powerkit3000.data.Models.AmazonCategory", b =>
                {
                    b.HasOne("powerkit3000.data.Models.AmazonCategory", "ParentCategory")
            ...
            modelBuilder.Entity("powerkit3000.data.Models.AmazonProduct", b =>
                {
                    b.HasOne("powerkit3000.data.Models.AmazonCategory", "Category")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("powerkit3000.data.Models.AmazonProductDataPoint", b =>
                {
                    b.HasOne("powerkit3000.data.Models.AmazonProduct", "Product")
                        .WithMany("DataPoints")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("powerkit3000.data.Models.AmazonSnapshot", "Snapshot")
                        .WithMany("DataPoints")
            ...
            modelBuilder.Entity("powerkit3000.data.Models.ProjectFavorite", b =>
                {
                    b.HasOne("powerkit3000.data.Models.KickstarterProject", "Project")
                        .WithMany("Favorites")
